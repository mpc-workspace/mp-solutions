        ...
        <div class="container">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3" data-aos="fade-up">
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">01</div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">02</div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">03</div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">04</div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">05</div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">06</div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-orange-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">07</div>
