    ...
    <section class="py-24">
        <div class="container">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3" data-aos="fade-up">
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    <span class="inline-block text-red-500 dark:text-blue-400">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">01</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Discovery</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        We begin by deeply understanding your business, its challenges, and its goals.
                    </p>
                </div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">02</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Strategy</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        Leveraging our experience and industry knowledge, we formulate a comprehensive strategy tailored to your unique needs.
                    </p>
                </div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">03</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Development</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        Our expert developers and engineers get to work, building and implementing the solutions outlined in the strategy. 
                    </p>
                </div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">04</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Testing and Quality Assurance:</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        Before any solution is deployed, it undergoes rigorous testing and quality assurance procedures. 
                    </p>
                </div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">05</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Deployment</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        Once thoroughly tested and refined, we deploy the solution in your environment.
                    </p>
                </div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">06</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Training and Support</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        We provide comprehensive training to your team to ensure they can fully leverage the new technology. 
                    </p>
                </div>
                ...
                <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6 relative">
                    ...
                    <div class="text-9xl text-red-300/10 font-bold absolute right-0 bottom-0 mx-4 pb-4">07</div>

                    <h4 class="text-xl font-bold text-gray-700 capitalize relative">Continuous Improvement</h4>

                    <p class="text-gray-500 dark:text-gray-300">
                        After deployment, we continue to monitor and improve the solution, keeping it up-to-date with the latest advancements in technology. 
                    </p>
                </div>
            </div>
        </div>
...
<script setup lang="ts">
    const metaTitle = ref('How We Work')
    const metaDescription = ref('Our approach to every project is characterized by a well-defined process that ensures success.')
