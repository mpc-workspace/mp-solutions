    ...
    <section class="pb-40 py-48 bg-gradient-to-br from-blue-50 via-pink-50 to-red-50 backdrop-blur-md">
        <div class="container text-center">
            <h1 class="flex flex-col text-5xl lg:text-6xl font-extrabold animate__animated animate__fadeInUp">
                <span class="leading-1 text-transparent bg-gradient-to-br bg-clip-text from-teal-500 via-blue-500 to-sky-500">
                    Innovative Solutions, 
                </span>

                <span class="leading-1 text-transparent bg-gradient-to-tr bg-clip-text from-yellow-500 via-orange-500 to-red-500">
                    Exceptional Results
                </span>
            </h1>

            <p class="lg:max-w-3xl lg:mx-auto mt-6 text-lg text-gray-600 md:text-xl animate__animated animate__fadeInUp">
                With a passion for excellence and a commitment to cutting-edge technologies, we empower businesses to thrive in the digital age.
            </p>
        ...
        <div class="container">
            <div class="grid grid-cols-1 gap-8 text-center md:grid-cols-2 lg:grid-cols-3">
                <div class="flex flex-col justify-center items-center" data-aos="fade-up" data-aos-duration="500">
                    <div class="bg-gray-50 w-fit rounded-xl p-4 shadow-sm border border-gray-200">
            ...
            <div class="flex flex-wrap lg:flex-nowrap items-center justify-between lg:gap-24">
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 md:grid-cols-2 xl:grid-cols-2" data-aos="fade-up">
                    <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6">
                        ...
                        <h1 class="text-xl font-bold text-gray-700 capitalize">Expertise</h1>
                    ...
                    <div class="lg:top-12 p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6">
                        ...
                        <h1 class="text-xl font-bold text-gray-700 capitalize">Customization</h1>

                        <p class="text-gray-500 dark:text-gray-300">
                            We understand that one size does not fit all, and we tailor our solutions to your specific needs.
                        </p>
                    </div>
                    ...
                    <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6">
                        ...
                        <h1 class="text-xl font-bold text-gray-700 capitalize">Reliability</h1>

                        <p class="text-gray-500 dark:text-gray-300">
                            We are committed to delivering on our promises and ensuring the success of your projects.
                        </p>
                    </div>
                    ...
                    <div class="p-8 space-y-3 border-2 bg-white border-gray-200 rounded-xl transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-6">
                        ...
                        <h1 class="text-xl font-bold text-gray-700 capitalize">Innovation</h1>

                        <p class="text-gray-500 dark:text-gray-300">
                            e continuously explore new technologies and strategies to keep your business ahead of the curve.
                        </p>
                    </div>
                </div>
            </div>
